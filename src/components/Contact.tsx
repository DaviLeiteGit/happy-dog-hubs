        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-5">
              {[
                ...
                { icon: MapPin, text: "São Paulo, SP - Atendimento domiciliar" },
          ...
          >
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              ...
              <button
                type="submit"
                className="w-full py-4 rounded-lg bg-accent text-accent-foreground font-body font-semibold text-lg hover:opacity-90 transition-opacity"
              >
                Enviar Mensagem
              </button>
            </form>
